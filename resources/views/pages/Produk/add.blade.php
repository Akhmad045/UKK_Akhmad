        ...
        <div class="col-5">
            <div class="card m-sm-auto">
                <div class="card-body p-3">
                    ...
                    <div class="col">
                        <form class="ms-4" method="POST" action="{{ url('dashboard/produk/tambah') }}">
                            @csrf
                            <div class="form-group">
                                <label for="nama_produk" class="form-control-label">Nama Produk</label>
                                <input class="form-control" type="text" name="nama_produk" id="nama_produk" autofocus required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="stok" id="example-url-input" required>
                            </div>
