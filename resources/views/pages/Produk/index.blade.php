        ...
        <div class="row mt-5">
            <div class="col">
                <div class="d-flex justify-content-end">
                    <a href="{{ url('dashboard/produk/tambah') }}" class="btn btn-light active"><i
                                    ...
                                    <tr>
                                        <th class="w-30">
                                            <div class="d-flex px-2 py-1 align-items-center">
                                                ...
                                                <div class="ms-4">
                                                    <p class="text-xs font-weight-bold mb-0">Nama Produk</p>
                                                    <h6 class="text-sm mb-0">{{ $item->nama_produk }}</h6>
                                                </div>
                                            </div>
                                        </th>
                                        <td>
                                        ...
                                        <td>
                                            <div class="text-center">
                                                ...
                                                <h6 class="text-sm mb-0">{{ $item->stok }}</h6>
                                            </div>
                                        </td>
                                        <td class="align-middle text-sm">
                                            <div class="col text-center">
                                                <p class="text-xs font-weight-bold mb-0">Aksi</p>
                                                <a href="{{ url('dashboard/produk/edit/' . $item->id) }}"><i
                                                        class="bi bi-pencil-square"></i></a>
                                                <a id="delete" href="{{ url('dashboard/produk/hapus/' . $item->id) }}"><i
